...
(function ($) {
    ...
    function Slide(ele, options) {
        ...
        this.states = [
            { 'zIndex': 1, width: 0, height: 0, bottom: 0, left: 134, $opacity: 0.5 },
            { 'zIndex': 2, width: 300, height: 200, bottom: 0, left: 0, $opacity: 0.6 },
            { 'zIndex': 3, width: 420, height: 280, bottom: 0, left: 70, $opacity: 0.7 },
            { 'zIndex': 4, width: 540, height: 360, bottom: 0, left: 170, $opacity: 1 },
            { 'zIndex': 3, width: 420, height: 280, bottom: 0, left: 390, $opacity: 0.7 },
            { 'zIndex': 2, width: 300, height: 200, bottom: 0, left: 580, $opacity: 0.6 },
            { 'zIndex': 1, width: 0, height: 0, bottom: 0, left: 670, $opacity: 0.5 }
        ]
        this.lis = this.$ele.find('li')
        this.interval
        // 点击切换到下一张

        this.$ele.find('.alxq-left').on('click', function () {
            this.stop()
            this.next()
            this.play()
        }.bind(this))
        // 点击切换到上一张
        this.$ele.find('.alxq-right').on('click', function () {
            this.stop()
            this.prev()
            this.play()
        }.bind(this))
